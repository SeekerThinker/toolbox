...
const files = ["core.js","tools-basic.js","tools-utility.js","tools-media.js","tools-focus.js","tools-thinking.js"];
...
if (ids.length !== 31) throw new Error(`expected 31 tools, found ${ids.length}`);
...
if (index.includes("compact.css")) throw new Error("legacy compact.css is still loaded");
