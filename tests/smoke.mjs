...
const files = ["core.js","tools-practical.js","tools-focus.js","tools-thinking.js","tools-external.js"];
...
if (ids.length !== 14) throw new Error(`expected 14 tools, found ${ids.length}`);
...
for (const legacy of ["tools-basic.js","tools-utility.js","tools-media.js","compact.css"]) {
